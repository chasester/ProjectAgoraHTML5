...
EPIC_MONO=""
if [ -f "C:\UE4-27-html5\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\UE4-27-html5\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
else
	EPIC_MONO="NOTE: It seems this $0 was built from another platform and copied here.\nNOTE: Was expecting to setup mono via: "'C:\UE4-27-html5\Engine\Build\BatchFiles\Mac\SetupMono.sh';
fi
